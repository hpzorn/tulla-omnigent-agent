...
> [`tulla`]([https://github.com/hpzorn/tulla)](https://github.com/hpzorn/tulla)) is the reference implementation; the shared semantic
> substrate (ontology server, pipeline ontologies, gate shapes) lives in
> [`semantic-tool-use`]([https://github.com/hpzorn/semantic-tool-use)](https://github.com/hpzorn/semantic-tool-use).
